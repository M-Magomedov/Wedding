...
public class UserService {
    ...
    public boolean createUser(User user){  //добавление роли пользователя
    ...
    public List<User> listUsers(){  //получить всех пользователей
        return userRepository.findAll();
    }

    public void banUser(Long id) { //бан пользователя по Id
